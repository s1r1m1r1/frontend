...
import 'package:frontend/app/router/go_router_module.dart' as _i602;
...
import 'package:frontend/features/admin/logic/admin.cubit.dart' as _i948;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i583.GoRouter>(
      () => goRouterModule.buildAdminRouter,
      instanceName: 'admin',
    );
    ...
    gh.factory<_i583.SenderCubit>(
      () => _i583.AdminSenderCubit(),
      instanceName: 'admin',
    );
    gh.factory<_i583.GoRouter>(
      () => goRouterModule.buildUserRouter,
      instanceName: 'user',
    );
    ...
    gh.factory<_i64.LettersBloc>(
      () => _i64.LettersBloc(gh<_i684.WsLettersRepository>()),
    );
    ...
    gh.factory<_i583.SenderCubit>(
      () => _i583.UserSenderCubit(gh<_i166.SessionRepository>()),
      instanceName: 'user',
    );
    gh.lazySingleton<_i31.ChopperClient>(
    ...
    gh.lazySingleton<_i730.AdminRepository>(
      () => _i730.AdminRepository(gh<_i164.ManualTokenApi>()),
    );
    ...
    gh.lazySingleton<_i233.AuthCubit>(
      () => _i233.AuthCubit(
...
class _$GoRouterModule extends _i602.GoRouterModule {}
